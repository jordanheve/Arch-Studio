...
export default function Footer() {
  return (
    <footer className='mt-48 flex  relative'>
        <div className='bg-black h-48 w-48 grid place-items-center'>
        <NavLink to='/'>
        ...
        <nav className='bg-slate-200 w-2/3 text-slate-500 font-semibold flex gap-10 items-center p-10 text-lg'>
        ...
        <Link
        to='/portfolio'
        className=' text-white absolute right-0 bottom-1/2 translate-y-1/2 bg-black flex items-center py-4 px-8 gap-4  font-semibold text-lg'>
        See Our Portfolio
