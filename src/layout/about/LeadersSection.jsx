...
export default function LeadersSection() {
  return (
    <section className="items-start lg:items-start justify-between flex max-lg:flex-col">
    <div>
    <h3 className="text-5xl sm:text-7xl font-bold">The <br/> Leaders</h3>
    </div>
    <div className=" grid sm:grid-cols-2 gap-6">
    {leadersData.map(item =>  (
      <div key={item.id}>
        <div className="relative cursor-pointer group mt-8">
